...
function startTask(index) {
  ...
  if (task.task_type === 'stroop') {
    ...
    if (questionEl) questionEl.innerHTML = `<span style="font-size:11px;color:#40484e;text-transform:uppercase;letter-spacing:0.15em;">${q.display_hint}</span><br><span style="font-size:2rem;font-weight:800;color:#00425e;letter-spacing:0.3em;">${seqStr}</span>`;
